...
def benchmark_search(query: str, iterations: int = 5) -> None:
    ...
    """
    print("=" * 80)
    print("BENCHMARK: Hybrid Search Performance Comparison")
    print(f"Query: '{query}'")
    ...
    for i in range(iterations):
        ...
        try:
            ...
            from l4_fts5_search import cmd_hybrid  # noqa: E402
    ...
    for i in range(iterations):
        start = time.time()
        try:
            from l4_fts5_search import cmd_hybrid_parallel  # noqa: E402
